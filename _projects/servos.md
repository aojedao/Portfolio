...
plots:
  - title: "Cartesian Path (X vs Y)"
    x_file: "/assets/data/plots/servos/robot_cartesian_simple.csv"
    x_column: 0
    y_files:
      - file: "/assets/data/plots/servos/robot_cartesian_simple.csv"
        column: 1
        label: "End Effector Path"
    x_label: "X Position (m)"
    y_label: "Y Position (m)"
  - title: "Joint Angles Over Time"
    x_file: "/assets/data/plots/servos/robot_joint_simple.csv"
    x_column: 0
    y_files:
      - file: "/assets/data/plots/servos/robot_joint_simple.csv"
        column: 1
